...
人格を使って **書く・決める・投票させる・問わせる** ためのスキル群。`/mind` `/minds` `/pair` が「議論用」なのに対し、こちらは「実行用」。
...
設計思想（AI臭を抜く3原則・人格別の出力比較・各Skillの実用シーン）は Qiita 記事で詳しく書いています → **[AIに書かせた記事が読む気しないのは「人格がない」からだ](https://qiita.com/yukurash/items/4c4bfc492d91770618b8)**
